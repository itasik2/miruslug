<?php
/**
 * Local Docker configuration for the restored MirUslug site.
 * Database credentials are read from container environment variables.
 */
$database_type = 'mysql';
$database_server = getenv('MIRUSLUG_DB_HOST') ? getenv('MIRUSLUG_DB_HOST') : 'db';
$database_user = getenv('MIRUSLUG_DB_USER') ? getenv('MIRUSLUG_DB_USER') : 'miruslug';
$database_password = getenv('MIRUSLUG_DB_PASSWORD') ? getenv('MIRUSLUG_DB_PASSWORD') : 'miruslug_local';
$database_connection_charset = 'utf8';
$database_connection_method = 'SET NAMES';
$db_name = getenv('MIRUSLUG_DB_NAME') ? getenv('MIRUSLUG_DB_NAME') : 'miruslug';
$dbase = '`' . $db_name . '`';
$table_prefix = 'srv_';

$lastInstallTime = 1431929483;
$site_sessionname = 'SN5559828ae7a71_local';
$https_port = '443';
...
if (empty($base_path) || empty($base_url) || (isset($_REQUEST['base_path']) && $_REQUEST['base_path']) || (isset($_REQUEST['base_url']) && $_REQUEST['base_url'])) {
    $sapi = 'undefined';
